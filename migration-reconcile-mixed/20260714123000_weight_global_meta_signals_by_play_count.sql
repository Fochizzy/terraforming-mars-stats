-- Re-rank Meta Winners & Draggers using both win-rate delta and play count.
-- Five prior plays temper small-sample outliers while allowing repeated
-- results to approach their observed delta as evidence accumulates.
