...
/** Shared existing Saved Games implementation for the legacy and canonical paths. */
export async function SavedGamesPage() {
  ...
  return (
    <AppShell
      hasActiveGroup
      headerActions={
        <GroupSwitcher currentGroupId={context.groupId} returnPath="/games" />
      }
      title="Saved Games"
    >
