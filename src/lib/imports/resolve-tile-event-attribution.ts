...
/**
 * Placement actions whose events carry actor evidence and are therefore
 * eligible for finalization-time attribution. This deliberately mirrors the
 * deployed `game_log_events_placement_action_check` vocabulary; a new action
 * has to be added here consciously rather than inherited by a wildcard.
 */
export const ATTRIBUTABLE_PLACEMENT_ACTIONS = ['placed', 'removed'] as const;
 ...
 * modelled; other stored fields are irrelevant here and stay untouched.
 */
