...
corporations, Preludes, maps, expansions, milestones, awards, declared styles,
...
| Games and status | Available now | games.status draft/finalized plus setup columns; game-draft-repo.ts; log form and all dashboards | Game grain; generation_count/player_count required, map optional; imports create drafts, not finalized structured games; exact for recorded fields | Join groups/maps/game expansions/promos. Finalized-only views exclude drafts. Preserve draft/finalized semantics in Phase 4. High |
...
| Corporations | Available now | corporations catalog; game_players.corporation_id; reference-repo.ts; log form and analytics | Player-game reference, nullable; historical coverage is measured; imports do not populate it; exact when selected | Join corporation/catalog and required expansions. Global aggregate access is authenticated and opt-in-group sourced. Phase 4/14. High |
| Preludes | Available now | preludes and game_player_preludes; reference-repo.ts; log form and analytics | Player-game-prelude relationship; zero rows may mean no Prelude expansion or missing entry; historical coverage varies; imports do not populate; exact when recorded | Join through game_players and expansion configuration. Add explicit “not used” versus missing coverage in Phase 2/4/14. High |
...
| Expansions and game configurations | Available now | expansions, game_expansions, promo_sets/game_promo_sets, catalog_snapshot_id, player_count, map_id; log form/reference repo | Game-expansion/promo relationships plus setup fields. Zero relationship rows can mean none selected or unrecorded; current imports retain setup only in an unfinalized draft | Join game/reference relationships. Add explicit coverage/versioning for historical catalog configuration in Phase 2/4/8. High |
...
- Finalized-game core: setup/status, final scores, placement, winners, recorded
  generation count, maps, expansion/promo configuration, corporations, and
  Preludes.
...
| Drafting | No explicit persisted drafting flag found | Add game configuration and coverage before adjustment. Expansion selection is not a reliable drafting proxy. |
| Expansions | game_expansions and game_promo_sets | Compare compatible configurations; expose sparse combinations and catalog snapshot. |
...
4. Absence of a relationship row can mean “none,” “feature not in use,” or
   “unrecorded” for Preludes, expansions, styles, key cards, milestones, awards,
   and events.
