-- Preludes are normally dealt at setup, but a few cards play further preludes
-- mid-game: Valley Trust's first action, the Board of Directors prelude's
-- action, and New Partner. Those are not selections the player made at setup,
-- so they are stored apart from game_player_preludes and are deliberately not
-- joined by the analytics views that measure starting-prelude performance.
