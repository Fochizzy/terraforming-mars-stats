-- Imported game logs often use short player names while the roster stores full
-- display names. Resolve tag summaries through confirmed game-log aliases
-- before falling back to the roster display name.
