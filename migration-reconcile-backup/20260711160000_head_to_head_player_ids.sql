-- Surface player ids in get_head_to_head_stats so the app can resolve each
-- player to their canonical display label (username, else first name). The
-- pairs previously exposed only raw display_name, which the head-to-head UI
-- rendered verbatim.
